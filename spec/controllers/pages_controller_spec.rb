  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved page as @page" do
        ...
        post :create, {:page => { "uid" => "invalid value" }}, valid_session
        assigns(:page).should be_a_new(Page)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested page" do
        ...
        Page.any_instance.should_receive(:update).with({ "uid" => "MyString" })
        put :update, {:id => page.to_param, :page => { "uid" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the page as @page" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Page.any_instance.stub(:save).and_return(false)
        put :update, {:id => page.to_param, :page => { "uid" => "invalid value" }}, valid_session
        assigns(:page).should eq(page)
      end
